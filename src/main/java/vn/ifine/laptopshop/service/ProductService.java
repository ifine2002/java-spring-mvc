    ...
    public void handleAddProductToCart(String email, long productId, HttpSession session, long quantity) {
        ...
        if (user != null) {
            ...
            if (p != null) {
                ...
                // this.cartDetailRepository.existsByCartAndProduct(cart, p);
                CartDetail oldCartDetail = this.cartDetailRepository.findByCartAndProduct(cart, p);
